  ...
  useEffect(() => {
    if (bgRef.current) {
      gsap.fromTo(
        bgRef.current,
        { scale: 1 },
        { scale: 1.12, duration: 55, ease: "none" },
      );
    }
  }, []);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.48) 35%, rgba(0,0,0,0.42) 60%, rgba(0,0,0,0.72) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 65% 50% at 50% 48%, rgba(196,162,101,0.12) 0%, transparent 70%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent 55%, rgba(245,240,232,0.05) 80%, rgba(245,240,232,0.1) 100%)",
        }}
      />
            ...
            >
              ...
              <motion.h2
                ...
                style={{
                  ...
                  color: "#FFFFFF",
                  textShadow:
                    "0 2px 30px rgba(0,0,0,0.6), 0 0 80px rgba(196,162,101,0.15)",
                }}
              >
                Happy Birthday
              </motion.h2>
              ...
              <motion.h1
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, #FFFFFF 0%, #FDF8F0 30%, #C4A265 65%, #D4B878 85%, #FFFFFF 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  backgroundClip: "text",
                  filter:
                    "drop-shadow(0 0 60px rgba(196,162,101,0.25)) drop-shadow(0 4px 40px rgba(0,0,0,0.4))",
                }}
              >
                Loveyy Jillian
              </motion.h1>
                ...
                <motion.button
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 8px 40px rgba(0,0,0,0.12), 0 0 60px rgba(196,162,101,0.1), inset 0 1px 0 rgba(255,255,255,0.1)";
