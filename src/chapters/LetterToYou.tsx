...
function FloralDivider() {
  return (
    ...
    >
      <path
        d="M60 28 C50 20, 20 18, 2 16"
        stroke="#C4A265"
        strokeWidth="0.8"
        opacity="0.5"
      />
      <path
        d="M60 28 C70 20, 100 18, 118 16"
        stroke="#C4A265"
        strokeWidth="0.8"
        opacity="0.5"
      />
...
function FloralCorner({ position }: { position: "tl" | "tr" | "bl" | "br" }) {
  ...
  return (
    <svg
      className={`absolute ${positions[position]} w-10 h-10 sm:w-14 sm:h-14 md:w-20 md:h-20 opacity-35`}
      viewBox="0 0 60 60"
      style={{ transform: transforms[position] }}
    >
      <path
        d="M5,5 Q15,8 25,5 Q35,2 45,5"
        stroke="#8FA58B"
        strokeWidth="0.8"
        fill="none"
      />
...
function LetterParagraph({
  ...
  const isShortEmphasis =
    text === "There's one thing I want you to always remember." ||
    text ===
      "And whatever happens, I hope you never forget that I'm here for you.";
  ...
  return (
    ...
    >
      ...
      {!isTitle && !isBible && !isRef && (
        <p
          className={`font-body text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] leading-[1.95] sm:leading-[2.1] tracking-[0.012em] mb-4 sm:mb-6 ${isShortEmphasis ? "font-semibold text-charcoal" : "text-charcoal-soft opacity-90"}`}
        >
          {text}
        </p>
      )}
...
export default function LetterToYou() {
  ...
  const handleOpen = useCallback(() => {
    ...
    const newPetals = Array.from({ length: 20 }, (_, i) => {
      ...
      return {
        ...
        color: ["#F2D7D9", "#D4A5A5", "#C9B1BD", "#E8C4C8"][
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen flex flex-col items-center py-16 sm:py-24 md:py-36 px-4 sm:px-6 overflow-hidden"
      style={{ zIndex: 2 }}
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 40%, rgba(196,162,101,0.08) 0%, transparent 60%)",
      ...
      <div
        className="absolute inset-0 pointer-events-none mix-blend-screen transition-opacity duration-1500"
        style={{
          background:
            "radial-gradient(circle at 80% 20%, rgba(212,165,165,0.12) 0%, rgba(196,162,101,0.1) 30%, transparent 60%)",
      ...
      {state === "reading" && (
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0 opacity-40 select-none">
          ...
          <div
            className="absolute -top-12 -left-12 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 rounded-full filter blur-[50px]"
            style={{
              background:
                "radial-gradient(circle, rgba(143,165,139,0.2) 0%, transparent 70%)",
            }}
          />
          {/* Blurred bottom-right roses */}
          <div
            className="absolute -bottom-20 -right-20 w-60 h-60 sm:w-80 sm:h-80 md:w-450px md:h-450px rounded-full filter blur-[60px]"
            style={{
              background:
                "radial-gradient(circle, rgba(212,165,165,0.25) 0%, transparent 70%)",
            }}
          />
          {/* Subtle sunlight ray overlay */}
          <div className="absolute top-0 right-4 sm:right-10 w-180px sm:w-300px h-screen bg-linear-to-b from-gold/5 to-transparent transform -skew-x-12 filter blur-40px" />
        </div>
      )}
      ...
      >
        <FloralDivider />
        <h2
          className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light tracking-[0.06em] mb-4 sm:mb-6"
          style={{ color: "#FDF8F0" }}
        >
          My Letter To You
        </h2>
        <p
          className="font-heading text-base sm:text-lg md:text-xl italic tracking-[0.08em]"
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                aspectRatio: "380 / 260",
                animation:
                  state === "sealed" ? "float 6s ease-in-out infinite" : "none",
              }}
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse, rgba(212,165,165,0.2) 0%, rgba(196,162,101,0.12) 45%, transparent 70%)",
                  filter: "blur(35px)",
                }}
              />
              ...
              >
                ...
                <div className="absolute inset-0 opacity-[0.05] flex items-center justify-center pointer-events-none">
                  ...
                  >
                    <path
                      d="M0,0 Q50,45 100,0 M0,100 Q50,55 100,100"
                      fill="none"
                      stroke="#C4A265"
                      strokeWidth="0.5"
                    />
              ...
              <motion.div
                ...
                style={{
                  ...
                  bottom: "6%",
                  background:
                    "linear-gradient(170deg, #FDF8F0 0%, #FAF3E8 100%)",
                  border: "1px solid rgba(196,162,101,0.12)",
                  boxShadow:
                    "0 4px 20px rgba(0,0,0,0.06), inset 0 0 20px rgba(196,162,101,0.03)",
                  zIndex:
                    state === "sliding-letter" || state === "zooming" ? 35 : 15,
                  originY: 1,
                }}
                animate={
                  state === "sealed" ||
              ...
              >
                ...
                <div className="absolute top-2 left-2 right-2 flex justify-between opacity-35">
                  ...
                  <svg
                    ...
                    height="20"
                    viewBox="0 0 24 24"
                    className="text-sage transform rotate-90"
                  >
                    <path
                      d="M2,2 Q10,4 12,12 Q4,10 2,2"
                      fill="none"
              ...
              <motion.div
                ...
                animate={{
                  rotateX:
                    state === "sealed" || state === "breaking" ? 0 : -180,
                }}
                transition={{
                  duration: 1.8,
                  ease: [0.22, 1, 0.36, 1],
              ...
              >
                <svg
                  ...
                  viewBox="0 0 380 130"
                  preserveAspectRatio="none"
                  className="w-full h-full drop-shadow-[0_6px_12px_rgba(0,0,0,0.12)]"
                >
                  {/* Top flap shape */}
                  <path
                    d="M0,0 L380,0 L190,130 Z"
                    fill="#EFE5D0"
                    stroke="#FAF5EB"
                    strokeWidth="1"
                  />
              ...
              <div
                ...
                style={{
                  ...
                  zIndex: 50,
                  display:
                    state === "sliding-letter" || state === "zooming"
                      ? "none"
                      : "block",
                }}
                onClick={handleOpen}
              >
                ...
                >
                  <div
                    ...
                    style={{
                      borderRadius: "50%",
                      background:
                        "radial-gradient(circle at 35% 35%, #D4A5A5 0%, #C9929B 45%, #B57A82 100%)",
                      boxShadow:
                        "0 4px 10px rgba(0,0,0,0.2), inset 0 1px 3px rgba(255,255,255,0.4)",
                    }}
                  >
                    {/* Gold emblem center (left half) */}
                    <div
                      className="absolute inset-0 flex items-center justify-center text-#D4B878 opacity-80"
                      style={{ transform: "translateX(2px)" }}
                    >
                      <svg width="22" height="22" viewBox="0 0 24 24">
                        <path
                          d="M12,4 C14,8 18,8 18,12 C18,16 14,20 12,20 C10,20 6,16 6,12 C6,8 10,8 12,4 Z"
                          fill="none"
                          stroke="currentColor"
                          strokeWidth="1.2"
                        />
                ...
                >
                  <div
                    className="w-56px h-56px -ml-28px"
                    style={{
                      borderRadius: "50%",
                      background:
                        "radial-gradient(circle at 35% 35%, #D4A5A5 0%, #C9929B 45%, #B57A82 100%)",
              ...
              {burstPetals.map((p) => (
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16">
                    <path
                      d="M8,1 Q15,4 12,12 Q8,15 4,12 Q1,4 8,1 Z"
                      fill={p.color}
                      opacity="0.8"
                    />
                  </svg>
        ...
        {state === "reading" && (
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(170deg, #FDF8F0 0%, #FAF3E8 60%, #F5ECE0 100%)",
                boxShadow:
                  "0 24px 70px rgba(0,0,0,0.12), 0 6px 20px rgba(0,0,0,0.06), inset 0 0 60px rgba(196,162,101,0.04)",
                minHeight: "min(1150px, 85vh)",
              }}
            >
              {/* Paper texture */}
              <div
                className="absolute inset-0 rounded-none opacity-[0.03] pointer-events-none"
                style={{
              ...
              <div
                className="relative z-10 space-y-4 sm:space-y-6 md:space-y-7 mt-4 sm:mt-6 mb-8 sm:mb-12
